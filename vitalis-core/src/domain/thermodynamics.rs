...
impl DNAThermodynamicsDatabase {
    ...
    fn load_nearest_neighbor_params(&mut self) {
        ...
        self.nearest_neighbor.insert("AA/TT".to_string(), ThermodynamicParams::new(-7.9, -22.2));
        self.nearest_neighbor.insert("AT/TA".to_string(), ThermodynamicParams::new(-7.2, -20.4));
        self.nearest_neighbor.insert("TA/AT".to_string(), ThermodynamicParams::new(-7.2, -21.3));
        self.nearest_neighbor.insert("CA/GT".to_string(), ThermodynamicParams::new(-8.5, -22.7));
        self.nearest_neighbor.insert("GT/CA".to_string(), ThermodynamicParams::new(-8.4, -22.4));
        self.nearest_neighbor.insert("CT/GA".to_string(), ThermodynamicParams::new(-7.8, -21.0));
        self.nearest_neighbor.insert("GA/CT".to_string(), ThermodynamicParams::new(-8.2, -22.2));
        self.nearest_neighbor.insert("CG/GC".to_string(), ThermodynamicParams::new(-10.6, -27.2));
        self.nearest_neighbor.insert("GC/CG".to_string(), ThermodynamicParams::new(-9.8, -24.4));
        self.nearest_neighbor.insert("GG/CC".to_string(), ThermodynamicParams::new(-8.0, -19.9));

        // Additional missing complementary pairs for complete coverage
        self.nearest_neighbor.insert("TG/CA".to_string(), ThermodynamicParams::new(-8.4, -22.4)); // Same as GT/CA
        self.nearest_neighbor.insert("AC/TG".to_string(), ThermodynamicParams::new(-8.5, -22.7)); // Same as CA/GT
        self.nearest_neighbor.insert("AG/TC".to_string(), ThermodynamicParams::new(-7.8, -21.0)); // Same as CT/GA
        self.nearest_neighbor.insert("TC/AG".to_string(), ThermodynamicParams::new(-8.2, -22.2)); // Same as GA/CT
    }
    ...
    fn load_initiation_params(&mut self) {
        ...
        self.initiation.insert("A".to_string(), ThermodynamicParams::new(2.3, 4.1));
        self.initiation.insert("T".to_string(), ThermodynamicParams::new(2.3, 4.1));
        self.initiation.insert("G".to_string(), ThermodynamicParams::new(0.1, -2.8));
        self.initiation.insert("C".to_string(), ThermodynamicParams::new(0.1, -2.8));
    }
    ...
    fn load_mismatch_params(&mut self) {
        ...
        self.mismatches.insert("GT/TG".to_string(), ThermodynamicParams::new(-4.1, -9.5));
        self.mismatches.insert("GG/TT".to_string(), ThermodynamicParams::new(-2.8, -5.3));
        self.mismatches.insert("TG/GT".to_string(), ThermodynamicParams::new(-4.1, -9.5));
        self.mismatches.insert("TT/GG".to_string(), ThermodynamicParams::new(-2.8, -5.3));

        // G·A ミスマッチ（Allawi & SantaLucia 1998）
        self.mismatches.insert("GA/AG".to_string(), ThermodynamicParams::new(-0.6, -1.3));
        self.mismatches.insert("GG/AA".to_string(), ThermodynamicParams::new(-0.6, -1.3));
        self.mismatches.insert("AG/GA".to_string(), ThermodynamicParams::new(-0.6, -1.3));
        self.mismatches.insert("AA/GG".to_string(), ThermodynamicParams::new(-0.6, -1.3));

        // A·A, C·C, G·G, T·T ミスマッチ（SantaLucia et al. 1999）
        self.mismatches.insert("AA/AA".to_string(), ThermodynamicParams::new(1.2, 1.7));
        self.mismatches.insert("CC/CC".to_string(), ThermodynamicParams::new(0.6, -0.6));
        self.mismatches.insert("GG/GG".to_string(), ThermodynamicParams::new(3.1, 5.8));
        self.mismatches.insert("TT/TT".to_string(), ThermodynamicParams::new(1.2, 1.7));

        // C·T ミスマッチ（基本的なもの）
        self.mismatches.insert("CT/TC".to_string(), ThermodynamicParams::new(-0.1, -1.5));
        self.mismatches.insert("CC/TT".to_string(), ThermodynamicParams::new(-0.1, -1.5));

        // 追加のミスマッチパラメータ（文献値に基づく）
        self.mismatches.insert("AC/CA".to_string(), ThermodynamicParams::new(2.3, 5.3));
        self.mismatches.insert("AT/TA".to_string(), ThermodynamicParams::new(1.2, 1.7));
    }

    /// ループパラメータを読み込み
    fn load_loop_params(&mut self) {
        // 対称内部ループ
        self.symmetric_internal_loops.insert("1".to_string(), ThermodynamicParams::new(0.0, -9.3));
        self.symmetric_internal_loops.insert("2".to_string(), ThermodynamicParams::new(0.0, -10.4));
        self.symmetric_internal_loops.insert("3".to_string(), ThermodynamicParams::new(0.0, -12.6));

        // 非対称内部ループ
        self.asymmetric_internal_loops.insert("1x2".to_string(), ThermodynamicParams::new(1.6, 0.0));
        self.asymmetric_internal_loops.insert("1x3".to_string(), ThermodynamicParams::new(1.9, 0.0));

        // バルジループ
        self.bulge_loops.insert("1".to_string(), ThermodynamicParams::new(3.8, 2.8));
        self.bulge_loops.insert("2".to_string(), ThermodynamicParams::new(2.8, -0.1));
        self.bulge_loops.insert("3".to_string(), ThermodynamicParams::new(3.2, 0.5));

        // ヘアピンループ
        self.hairpin_loops.insert("3".to_string(), ThermodynamicParams::new(5.7, 9.4));
        self.hairpin_loops.insert("4".to_string(), ThermodynamicParams::new(5.6, 9.5));
        self.hairpin_loops.insert("5".to_string(), ThermodynamicParams::new(5.8, 10.2));
    }

    /// 特殊配列パラメータを読み込み
    fn load_special_sequences(&mut self) {
        // TLOOP、CLOOP等の特殊配列
        self.special_sequences.insert("TLOOP".to_string(), ThermodynamicParams::new(-1.0, -4.0));
        self.special_sequences.insert("CLOOP".to_string(), ThermodynamicParams::new(-0.5, -2.0));
    }
    ...
    fn load_santalucia_1998_params(&mut self) {
        // 既存の実装と同じパラメータ
        self.nearest_neighbor.insert("AA/TT".to_string(), ThermodynamicParams::new(-7.9, -22.2));
        self.nearest_neighbor.insert("AT/AT".to_string(), ThermodynamicParams::new(-7.2, -20.4));
        self.nearest_neighbor.insert("TA/TA".to_string(), ThermodynamicParams::new(-7.2, -21.3));
        self.nearest_neighbor.insert("CA/TG".to_string(), ThermodynamicParams::new(-8.5, -22.7));
        self.nearest_neighbor.insert("GT/AC".to_string(), ThermodynamicParams::new(-8.4, -22.4));
        self.nearest_neighbor.insert("CT/AG".to_string(), ThermodynamicParams::new(-7.8, -21.0));
        self.nearest_neighbor.insert("GA/TC".to_string(), ThermodynamicParams::new(-8.2, -22.2));
        self.nearest_neighbor.insert("CG/CG".to_string(), ThermodynamicParams::new(-10.6, -27.2));
        self.nearest_neighbor.insert("GC/GC".to_string(), ThermodynamicParams::new(-9.8, -24.4));
        self.nearest_neighbor.insert("GG/CC".to_string(), ThermodynamicParams::new(-8.0, -19.9));
